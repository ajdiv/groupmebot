export abstract class TextUtilities {
  /**
     ...
     */
  public static wordCanSynonym(word: string): boolean {
  ...
  /**
     ...
     */
  public static parseAndScrub(phrase: string): string[] {
  ...
  public static pickRandomWord(synArr: string[]): string {
